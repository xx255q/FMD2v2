...
function GetInfo()
	...
	if HTTP.GET(MANGAINFO.URL) then
		...
		if MODULE.ID == '58a2dec76ebf43a5a9e7dc9b453e52e9' then -- HentaiFox
			...
			MANGAINFO.Genres     = x.XPathStringAll('//ul[@class="parodies" or @class="tags" or @class="languages" or @class="categories"]/li/a/text()[not(parent::span)]')
		else
			...
			MANGAINFO.Genres     = x.XPathStringAll('//ul[@class="galleries_info"]/li[contains(.,"Parodies") or contains(.,"Tags") or contains(.,"Languages") or contains(.,"Category")]/a/text()[not(parent::span)]')
		end
