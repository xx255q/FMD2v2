...
function Init()
	...
	AddWebsiteModule('c01aa037f7f1459984e7cd8676fe9658', 'MangaRead', 'https://www.mangaread.org', cat)
	...
	AddWebsiteModule('f95e0abd491e48aa81e686d14c0b983f', 'MartialScans', 'https://martialscans.com', cat)
	AddWebsiteModule('c07a3a37cb3f4e1a8fe48ad156056887', 'HeroManhua', 'https://heromanhua.com', cat)
	AddWebsiteModule('b810006e1bba4fe3a22bdbf9b235a537', 'MangaTurf', 'https://mangaturf.com', cat)
	...
	AddWebsiteModule('689a65d9f4694e9389928304053c97fc', 'NightComic', 'https://nightcomic.com', cat)
	...
	AddWebsiteModule('2b653482cef845d980a0cba2a7e798e0', 'PhenomenalNoFansub', 'https://phenomenalnofansub.com', cat)
	AddWebsiteModule('adaa36e7f591470685788d0e8ae31230', 'TraduccionesAmistosas', 'https://scantraduccionesamistosas.xyz', cat)
	AddWebsiteModule('6d15a803c5504e91918a9d5f2b1351f8', 'WebtoonXYZ', 'https://www.webtoon.xyz', cat)
	AddWebsiteModule('249da73cb3e941f2932b0435710e4a65', 'ManhwaPool', 'https://manhwapool.com', cat)
	AddWebsiteModule('9bd1dd136cef40608ed691546251f46b', 'AHStudios', 'https://ahstudios.net', cat)
	AddWebsiteModule('31507116492d4ac3ba197c5e386ff872', 'AlianzaMarcial', 'https://www.alianzamarcial.xyz', cat)
	...
	AddWebsiteModule('f31e7a36050c424291c839f0a02d92a4', 'ApollComics', 'https://apollcomics.xyz', cat)
	AddWebsiteModule('404bb1f54c374a53bd850afdd6f873b3', 'ToonilyNet', 'https://toonily.net', cat)
	AddWebsiteModule('ae84d6cc416a473d85cf9fa416305378', 'SkyManga', 'https://skymanga.co', cat)
