...
function GetPageNumber()
	...
	vm.CurPathName = body:match('vm.justgiveupalready = "(.-)"')
	...
	vm.CurURI = body:match('ng%-src="(https?://{{vm%.justgiveupalready}}.-){{vm%.CurChapter%.Directory'):gsub('{{vm%.justgiveupalready}}', vm.CurPathName)
